            ...
            lg:after:top-full lg:after:left-1/2 lg:after:w-[97%] lg:after:h-3 lg:after:rounded-b-md lg:after:rounded-t-none lg:after:-translate-x-1/2">
                ...
                <div className="w-full flex flex-wrap justify-between py-0 px-5 text-base font-medium mb-5">
                    {days.map((day, idx) => (
                        ...
                        ${isSameMonth(day, firstDayCurMonth) ? ' text-violet-300 hover:text-white hover:bg-violet-300' : 'text-[#b3b3b3]'}
                    ...
                    {/* <div className="w-[14.28%] h-[80px] flex items-center justify-center cursor-pointer border border-solid text-violet-300 hover:text-white hover:bg-violet-300 relative after:absolute after:bottom-[10%] after:left-1/2 after:w-3/4 after:h-1 after:rounded-3xl after:-translate-x-1/2 after:bg-violet-300 hover:after:bg-white">1</div> */}
                </div>
                <div className="w-full h-12 flex items-center justify-between gap-1 py-0 px-5 mb-5 text-violet-300">
                    <div className="flex items-center rounded-md overflow-hidden border-solid border border-violet-300">
                        <input type="text" onChange={(e) => setinput(e.target.value)} value={input} placeholder="mm/yyyy" className="w-full h-8 outline-none border-none rounded-md px-2" />
